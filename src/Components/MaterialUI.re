...
[@bs.module "@material-ui/core/styles"]
external makeStyles : (Js.Dict.t(string), 'a) => Js.Dict.t(string) = "makeStyles";
...
module Avatar {
    ...
    external make : (~src:string=?,~className:string=?,~children:React.element) => React.element = "default";
}
...
module Checkbox {
    ...
    external make : (
        ...
        ~value:string=?, 
        ~color:string=?,
        ~onChange:(ReactEvent.Synthetic.t)=>unit=?) => React.element = "default";
}
...
module FormControl {
    ...
    external make : (~id:string=?,~variant:string=?,~className:string=?,~children:React.element=?) => React.element = "default";
    ...
    module Jsx2 {
        ...
        let make = (
            ...
            ~variant=?,
            ~className=?, 
            children) => ReasonReactCompat.wrapReactForReasonReact(
        make,
...
module FormControlLabel {
    ...
    external make : (~control:React.element, ~label:string) => React.element = "default";
}
...
module InputLabel {
    ...
    module Jsx2 {
        ...
        let make = (
            ...
            children) => ReasonReactCompat.wrapReactForReasonReact(
        make,
        makeProps(~id?, ~htmlFor?, ~className?, ~children=children |> React.array, ()),
        children,
        );        
    }
}
...
module ListItemText {
    ...
    external make : (~primary:string=?,~children:React.element=?) => React.element = "default";
}

module ListSubheader {
    [@react.component] [@bs.module "@material-ui/core/ListSubheader"]
    external make : (~inset:bool=?,~children:React.element=?) => React.element = "default";
}
...
module TextField {
    ...
    external make : (
        ...
        ~required:bool=?,
        ~onChange:ReactEvent.Form.t=>unit=?,
        ~type_:string=?) => React.element = "default";
}
