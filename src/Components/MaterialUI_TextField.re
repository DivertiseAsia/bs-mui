...
type props('a, 'b, 'c, 'd, 'e) = {
  ...
  [@bs.optional][@bs.as "FormHelperTextProps"] oFormHelperTextProps: 'a,
  [@bs.optional][@bs.as "InputLabelProps"] oInputLabelProps: 'b,
  [@bs.optional][@bs.as "InputProps"] oInputProps: 'c,
