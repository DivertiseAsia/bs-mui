...
type action = ChangeTargetValue(string)
...
let make = () => {
  ...
  let demoCode =
    <Jsx3LayoutComponent title="Radio" mainInfo>
      ...
      />
      <Radio value="b" name="radio-button-demo" color="default" disabled=true />
    </Jsx3LayoutComponent>

  let demoCodeString = "<Jsx3LayoutComponent title='Radio' mainInfo>  
    <Radio
      value='a'
      name='radio-button-demo'
      onChange=(_ => dispatch(ChangeTargetValue('a')))
