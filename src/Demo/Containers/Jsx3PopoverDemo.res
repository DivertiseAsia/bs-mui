...
let horizontalPositions = list{"left", "center", "right"}
...
let make = () => {
  ...
  let demoCode =
    <Jsx3LayoutComponent title="Popover" mainInfo>
      ...
      <br />
      <br />
      {string("Anchor Origin Vertical")}
      <br />
      {verticalPositions
      |> List.mapi((index, verticalPosition) =>
        <React.Fragment key={"Anchor-Origin-Vertical" ++ (index |> string_of_int)}>
          ...
          <Radio
            ...
            onChange={_ =>
              dispatch(
                ChangeAnchorOrigin(
                  updateAnchorPlayground(verticalPosition, state.anchorOrigin.horizontal),
                ),
              )}
      ...
      |> array}
      <br />
      {string("Anchor Origin Horizontal")}
      <br />
      {horizontalPositions
      |> List.mapi((index, horizontalPosition) =>
        <React.Fragment key={"Anchor-Origin-Horizontal" ++ (index |> string_of_int)}>
          ...
          <Radio
            ...
            onChange={_ =>
              dispatch(
                ChangeAnchorOrigin(
                  updateAnchorPlayground(state.anchorOrigin.vertical, horizontalPosition),
                ),
              )}
      ...
      |> array}
      <br />
      {string("Transform Origin Vertical")}
      <br />
      {verticalPositions
      |> List.mapi((index, verticalPosition) =>
            ...
            onChange={_ =>
              dispatch(
                ChangeTransformOrigin(
                  updateAnchorPlayground(verticalPosition, state.transformOrigin.horizontal),
                ),
              )}
      ...
      |> array}
      <br />
      {string("Transform Origin Horizontal")}
      <br />
      {horizontalPositions
      |> List.mapi((index, horizontalPosition) =>
        <React.Fragment key={"Transform-Origin-Horizontal" ++ (index |> string_of_int)}>
          ...
          <Radio
            ...
            onChange={_ =>
              dispatch(
                ChangeTransformOrigin(
                  updateAnchorPlayground(state.transformOrigin.vertical, horizontalPosition),
                ),
              )}
  ...
  let demoCodeString = "<Jsx3LayoutComponent title='Popover' mainInfo>  
    <ClickAwayListener onClickAway={_=>setAnchorEl(_=>Js.Nullable.null)}>
        <Button 
          variant=Button.Variant.contained 
          color='default' 
