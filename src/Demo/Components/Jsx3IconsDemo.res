...
let make = () => {
  ...
  let demoCode =
    <Jsx3LayoutComponent title="Icons" mainInfo>
      <Grid.Container spacing=3>
        <Grid.Item xs={GridSize.size(6)}> <Paper> {string("SvgIcon")} </Paper> </Grid.Item>
        ...
        <Grid.Item xs={GridSize.size(6)}> <Paper> {string("Color")} </Paper> </Grid.Item>
        <Grid.Item xs={GridSize.size(6)}>
          <Paper>
            <Icon.Layers />
  ...
  let demoCodeString = "<Jsx3LayoutComponent title='Icons' mainInfo>  
