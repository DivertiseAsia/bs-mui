...
let make = () => {
  let demoCode =
    <Jsx3LayoutComponent title="Form Control">
      <FormControl variant=Variant.outlined>
        <InputLabel id="demo-simple-select-outlined-label"> {string("Age")} </InputLabel>
        <Select
          labelId="demo-simple-select-outlined-label" id="demo-simple-select-outlined" value=10>
          <MenuItem value=""> <em> {string("None")} </em> </MenuItem>
  ...
  let demoCodeString = "<Jsx3LayoutComponent title='Form Control'> 
    <FormControl variant=Variant.outlined>
